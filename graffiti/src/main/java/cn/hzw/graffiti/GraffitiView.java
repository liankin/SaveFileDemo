...
*/
    ...
    public void init() {
        ...
        mScale = 1f;
        mColor = new GraffitiColor(Color.BLACK);
        mPaint = new Paint();
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (isPenSelectable()) {
                    ...
                    if (mIsPainting) {
                        ...
                        GraffitiPath path = GraffitiPath.toPath(mPen, mShape, mPaintSize, mColor.copy(), mCurrPath, mGraffitiRotateDegree, mOriginalPivotX, mOriginalPivotY, getCopyLocation());
                        addPath(path);
                        mIsPainting = false;
                    }
                }
